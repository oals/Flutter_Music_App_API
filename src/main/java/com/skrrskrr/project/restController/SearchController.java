...
public class SearchController {
    ...
    public HashMap<String,Object> getSearchTrack(@RequestParam Long memberId, @RequestParam String searchText, @RequestParam Long listIndex) {
    ...
    public HashMap<String,Object> getSearchInit(@RequestParam Long memberId){
    ...
    public HashMap<String,Object> getsearchMore(@RequestParam Long memberId, @RequestParam Long moreId,@RequestParam String searchText,@RequestParam Long listIndex){
